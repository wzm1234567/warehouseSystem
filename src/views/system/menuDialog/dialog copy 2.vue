  ...
  <div>
    <t-dialog :header="title" :visible.sync="visible" @confirm="onConfirm" width="40%" :onConfirm="onConfirmAnother"
      ...
      <div style="margin-top:30px">
        <t-form :data="formData" labelWidth="calc(2em + 54px)" ref="form" scrollToFirstError="smooth">
          <t-form-item label="上级菜单" help="想要创建根路由,请选择根路由" name="region">
            ...
            <el-cascader z-index="99999" :value="formData.region"  :options="options" :props="{ checkStrictly: true, }" :filterable="true" clearable></el-cascader>
            <!-- <el-cascader placeholder="试试搜索：指南" :options="options" filterable></el-cascader> -->
            <!-- <t-cascader v-model="formData.region" :options="options" checkStrictly clearable :max="1" /> -->
          </t-form-item>
